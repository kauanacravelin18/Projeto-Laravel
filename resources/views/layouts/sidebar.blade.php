    ...
    >
        ...
        <div class="h-16 flex items-center gap-3 px-5 border-b border-slate-800 shrink-0">
            ...
            <span class="text-white font-bold leading-tight text-sm">
                SISTEMA DE<br>
                <span class="text-blue-500">ALMOXARIFADO</span>
            </span>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            {{-- Itens --}}
            <x-sidebar-link
                :href="route('itens.index')"
                :active="request()->routeIs('itens.*')"
            >
                <x-slot name="icon">
                    <path
                        stroke-linecap="round"
            ...
            {{-- Locais --}}
            <x-sidebar-link
                :href="route('locais.index')"
                :active="request()->routeIs('locais.*')"
            >
                <x-slot name="icon">
                    <path
                        stroke-linecap="round"
            ...
            <x-sidebar-link
                ...
                :active="request()->routeIs('movimentacoes.*')"
            >
                <x-slot name="icon">
                    <path
                        stroke-linecap="round"
