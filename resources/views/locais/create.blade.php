...
@section('content')
    <h1 class="text-2xl font-semibold mb-6">Novo local</h1>

    <form action="{{ route('locais.store') }}" method="POST" class="bg-white rounded-lg shadow-sm p-6 space-y-4 max-w-xl">
        @csrf
